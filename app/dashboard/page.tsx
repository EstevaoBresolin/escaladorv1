  ...
  if (isMember) {
    return (
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
        <section className="rounded-2xl border border-border/70 bg-card p-5 shadow-sm md:p-6 flex flex-col items-center text-center">
          <div className="flex flex-col items-center gap-3">
            <span className="rounded-xl bg-primary/15 text-primary p-4">
              <svg
            ...
            <h1 className="mt-2 text-2xl font-semibold tracking-tight text-foreground md:text-3xl">
              Bem-vindo ao dashboard da igreja!
            </h1>
            <p className="mt-2 max-w-xl text-sm text-muted-foreground">
              Para começar a participar das escalas e atividades, solicite ao
              seu líder que o adicione a um ministério.
              <br />
              Assim que for incluído, você poderá adicionar sua disponibilidade,
              acompanhar eventos e consultar suas escalas.
            </p>
          </div>
        </section>
      </div>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
                Acompanhe indicadores, próximos eventos e ações importantes em
                um único lugar.
              </p>
            </div>

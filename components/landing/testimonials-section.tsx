...
const testimonials = [
  {
    ...
    content:
      "O Conecte Escalas transformou a forma como organizamos nossos ministérios. Antes, passávamos horas no WhatsApp tentando montar escalas. Agora, tudo é feito em minutos.",
    rating: 5,
  },
  {
    name: "Maria Santos",
  ...
  },
  {
    ...
    content:
      "Gerenciamos 12 ministérios com mais de 200 voluntários. O Conecte Escalas nos deu a visibilidade que precisávamos para coordenar tudo de forma eficiente.",
    rating: 5,
  },
]
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-16 max-w-2xl text-center">
          <h2 className="mb-4 text-balance text-3xl font-bold text-foreground md:text-4xl">
            Igrejas que confiam no Conecte Escalas
          </h2>
